...
### Model implementation is based on https://github.com/SullyChen/Autopilot-TensorFlow, 
### We change the model to commai's model from https://github.com/commaai/research/blob/master/train_steering_model.py
