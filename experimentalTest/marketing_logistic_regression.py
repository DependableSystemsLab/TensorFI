...
y = tf.placeholder(tf.float32, [None, 2]) # if a client will subscribe a term deposit ==> 2 classes
...
with tf.Session() as sess:
    ...
    print("Accuracy (With FI):", accuracy.eval({x: batch_xs[20000:], y: labels[20000:]}))
